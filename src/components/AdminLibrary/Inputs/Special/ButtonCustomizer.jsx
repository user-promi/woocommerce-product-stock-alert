            ...
            {select === "color" && (
              <div className="section-wrapper color">
                ...
                >
                  <div className="section">
                    <span className="lable">
                      {__("Background Color On Hover", "notifima")}
                    </span>
                    <div className="property-section">
                      <input
                        type="color"
                  ...
                  <div className="section">
                    <span className="lable">
                      {__("Font Color On Hover", "notifima")}
                    </span>
                    <div className="property-section">
                      <input
                        type="color"
            ...
            {select === "border" && (
              <div className="section-wrapper border">
                ...
                <div className="section-wrapper hover">
                  <div className="section">
                    <span className="lable">
                    {__("Border Color On Hover", "notifima")}
                    </span>
                    <div className="property-section">
                      <input
                        type="color"
